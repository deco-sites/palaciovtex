...
function ProductGallery({ 
  ...
  return (
    <div class={`grid ${mobile} xl:grid-cols-2 gap-2 items-center ${desktop} sm:gap-10`}>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div class={`text-white bg-black block text-center relative  text-sm uppercase rounded-md ` }>
                    ...
                    <div class={`visible opacity-100 inline-block  w-full pb-[5px] transition-all mt-[15px]`}>
