    ...
    <div class="flex flex-col max-w-[95%] m-auto md:max-w-full" id={id}>
      ...
      <div class="mt-4">
        <div class={`text-left`}>
          ...
          <div class={`w-fit text-black px-3 py-1 font-bold bg-[#F0D02C] flex items-center gap-1 text-center relative text-sm md:text-base uppercase rounded-md `}>
          ...
          {installments && (
            <div class="w-fit block rounded-md text-white px-3 py-1 bg-black text-base leading-[19px] mt-2.5">
              ou {formatPrice(
                price,
                offers?.priceCurrency,
        ...
        <div class="product-social-links">
          <div class="product-share">
            <div class="flex items-center gap-2">
              ...
              >
                <svg
                  class="jam jam-facebook group-hover/link:fill-white"
                  width="32"
                  height="32"
                  viewBox="-7 -2 24 24"
                ...
                >
                  <path d="M2.046 3.865v2.748H.032v3.36h2.014v9.986H6.18V9.974h2.775s.26-1.611.386-3.373H6.197V4.303c0-.343.45-.805.896-.805h2.254V0H6.283c-4.34 0-4.237 3.363-4.237 3.865" />
                </svg>
              </a>
              <a
              ...
              >
                <svg
                  class="group-hover/link:fill-white"
                  width="32"
                  height="32"
                  viewBox="0 0 48 48"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g data-name="Layer 2">
                    <path
                      ...
                      d="M0 0h48v48H0z"
                    />
                    <path d="M38.9 8.1A20.9 20.9 0 0 0 3.2 22.8 19.8 19.8 0 0 0 6 33.2L3 44l11.1-2.9a20.3 20.3 0 0 0 10 2.5A20.8 20.8 0 0 0 38.9 8.1m-14.8 32a17.1 17.1 0 0 1-9.5-2.8L8 39.1l1.8-6.4a17.9 17.9 0 0 1-3.1-9.9 17.4 17.4 0 1 1 17.4 17.3" />
                    <path d="M33.6 27.2a29 29 0 0 0-3.6-1.7c-.4-.2-.8-.3-1.1.2s-1.4 1.7-1.7 2.1a.8.8 0 0 1-1.1.1 15.2 15.2 0 0 1-4.2-2.6 15 15 0 0 1-2.9-3.6.7.7 0 0 1 .2-1l.8-1a3.5 3.5 0 0 0 .5-.8.9.9 0 0 0 0-.9c-.2-.3-1.2-2.8-1.6-3.9s-.9-.9-1.2-.9h-1a1.7 1.7 0 0 0-1.4.7 5.5 5.5 0 0 0-1.8 4.3 10.4 10.4 0 0 0 2.1 5.4c.3.3 3.7 5.6 8.9 7.8a16.4 16.4 0 0 0 3 1.1 6.4 6.4 0 0 0 3.3.2c1-.1 3.1-1.2 3.5-2.4s.5-2.3.3-2.5a2.1 2.1 0 0 0-1-.6" />
                  </g>
                </svg>
              </a>
              <a
